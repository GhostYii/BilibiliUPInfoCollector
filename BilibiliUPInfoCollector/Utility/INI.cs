...
public static class INI
{
    ...
    /// 配置文件存储文件夹路径
    /// </summary>
    public static readonly string IniSaveDirectory = BilibiliUPInfoCollector.Utility.Path.CurrentDirectory;

    /// <summary>
    /// 配置文件存储路径
    /// </summary>
    public static readonly string IniSavePath = BilibiliUPInfoCollector.Utility.Path.INIFile;
